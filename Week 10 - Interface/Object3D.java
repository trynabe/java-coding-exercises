...
public abstract class Object3D {
	...
	{
		//****************** YOUR CODE HERE *************************//
		return DENSITIES[this.getMaterial().ordinal()] * this.getVolume();
		//***********************************************************//
	}
	...
	{
		//****************** YOUR CODE HERE *************************//
		return DENSITIES[this.getMaterial().ordinal()] < DENSITIES[Material.Water.ordinal()];
		//***********************************************************//
	}
	...
	{
		//****************** YOUR CODE HERE *************************//
		return DENSITIES[this.getMaterial().ordinal()] < DENSITIES[Material.Air.ordinal()];
		//***********************************************************//
	}
